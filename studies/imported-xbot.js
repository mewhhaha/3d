...
import {xbotNames,xbotStance,xbotPoised} from './xbot-pose.js';
...
export default defineModel({id:'imported-xbot',title:'Actual Mixamo Xbot / pose study',parameters:{},build:()=>{
 ...
 root.animations=[rig.hold('neutral',r=>xbotStance(r,{confident:false})),rig.hold('confident',r=>xbotStance(r)),rig.hold('poised',r=>xbotPoised(r))];
