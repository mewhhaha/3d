...
export default defineModel({id:'prism-body',title:'Connected ribcage, limb roots and joint cowls',parameters:{surfaceStyle:{type:'select',options:['plain','pigment','outlined'],default:'plain'},girdleStyle:{type:'select',options:['legacy','connected'],default:'legacy'},handStyle:{type:'select',options:['legacy','relaxed'],default:'legacy'},panelStyle:{type:'select',options:['broad','cutaway'],default:'broad'},massStyle:{type:'select',options:['profiled','sculpted','structured'],default:'profiled'},gestureStyle:{type:'select',options:['fixed','counterpose','lookback'],default:'counterpose'},jointStyle:{type:'select',options:['open','housed'],default:'housed'}},build:p=>{
