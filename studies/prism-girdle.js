...
export default defineModel({id:'prism-girdle',title:'Neck and shoulder-girdle construction',parameters:{girdleStyle:{type:'select',options:['legacy','connected'],default:'connected'}},build:p=>{
