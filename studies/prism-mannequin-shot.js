...
import {shotProportions,shotPose,stancePose} from './prism-mannequin-pose.js';
export default defineModel({id:'prism-mannequin-shot',title:'Prism / plain pose before costume',parameters:{},build:()=>{
 const subject=humanoidMannequin({...shotProportions,poses:{baseline:humanoidPose('lookback'),shot:shotPose,stance:stancePose}});
