...
import { cyberMaterials, panel, radialPort, cableCurve, routedCable, cableLoom, orient } from '../src/lib/cyber/mechanics.js';
...
test('emitter materials are build-owned and loom palettes are explicit',()=>{
 ...
 const loom=cableLoom({points:[[0,0,0],[0,.3,.1],[.1,.6,0]]},a);assert.equal(loom.children.length,3);dispose(loom);
});
